        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="text-center lg:text-right flex-1 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a href="tel:0546142426" className="bg-secondary text-foreground px-8 py-4 rounded-xl font-semibold text-lg border border-border hover:border-primary hover:bg-secondary/80 transition-all duration-300 flex items-center justify-center gap-3 whitespace-nowrap">
                <svg className="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                054-614-2426
              </a>
              <a href="https://www.instagram.com/orlevy.finance?igsh=dmFtNjAwaGxqdGR0" target="_blank" rel="noopener noreferrer" className="bg-secondary text-foreground p-4 rounded-xl border border-border hover:border-primary hover:bg-secondary/80 transition-all duration-300 flex items-center justify-center" aria-label="אינסטגרם">
