        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="text-center lg:text-right flex-1 max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              אור
              <span className="text-gradient-gold block mt-2">יועץ פיננסי ומומחה ביטוח</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="https://wa.me/972546142426"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-gold text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg shadow-gold hover:scale-105 transition-transform duration-300 flex items-center justify-center gap-3"
              >
              ...
              <a
                href="tel:0546142426"
                className="bg-secondary text-foreground px-8 py-4 rounded-xl font-semibold text-lg border border-border hover:border-primary hover:bg-secondary/80 transition-all duration-300 flex items-center justify-center gap-3"
              >
