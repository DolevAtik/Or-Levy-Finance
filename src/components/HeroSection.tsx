...
יועץ פיננסי ומומחה ביטוח<span className="text-gradient-gold block mt-2">יועץ פיננסי ומומחה ביטוח</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="https://wa.me/972546142426" target="_blank" rel="noopener noreferrer" className="bg-gradient-gold text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg shadow-gold hover:scale-105 transition-transform duration-300 flex items-center justify-center gap-3">
